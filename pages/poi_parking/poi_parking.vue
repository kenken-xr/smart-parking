		...
		<view class="pois-show" @load="getPois(1)">
			<scroll-view :scroll-top="scrollTop" scroll-y="true" class="scroll-y">
				...
				<view class="item">
					...
					<view class="wenzi">
						<view>
							<text class="name-style">群光广场地下停车场（方便测试）</text>
						</view>
						<view class="all-style">
							<text class="type-style">地下停车场</text>
							<text class="point-style">·</text>
							<text class="address-style">湖北省武汉市洪山区</text>

						</view>
					</view>
					<image class="tran_indoor" @click="clicktoindoor()" src="../../static/imgs/tran_indoor.png" mode="">
					</image>

					<image class="wish" src="../../static/imgs/wish.png" mode=""></image>
					<!-- 	<image class="wish" src="../../static/imgs/wish_selected.png" v-show="!showUpImg[poi.index]"
						@click="changeImg(poi)" mode=""></image> -->

					<image class="drive" 
					@click="viewMapLocation('114.354984,30.524855','群光广场地下停车场')"
				...
				<view class="item" v-for="poi in showPois" :key="poi.id">
					...
					<view class="wenzi">
						...
						<view class="all-style">
							<text class="type-style">{{poi.parking_type?poi.parking_type+'停车场':'停车场'}}</text>
							<!-- <text class="zi-style">停车场</text> -->
							<text class="point-style">·</text>
							<text class="address-style">{{poi.address.length!=0 ? poi.address : poi.name}}</text>

						</view>
					</view>
					<image class="tran_indoor"  src="../../static/imgs/tran_indoor.png" mode="">
					</image>
	...
	export default {
		data() {
			return {
				...
				poiType: {
					1: "150900|150903|150904|150905|150906|150907|150908|150909", //停车场相关
				},
				activeLimit: 15,
				//这个长度根据需要改
				// showUpImg: [],
